    ...
    return (
        <div>
            ...
            <section className="section pb-0 section-components ">
                <section className="section pb-0 section-components ">
                    <Container className="mb-5">
                        <Card className="card-profile shadow mt--250 "  data-aos="flip-left" >
                ...
                <section className="section pb-0 section-components ">
                    <Container className="mb-5">
                        <Card className="card-profile shadow mt-150 " data-aos="flip-right" >
                ...
                <section className="section section-components " >
                    <Container className="mb-5">
                        <Card className="card-profile shadow mt-150 " data-aos="flip-left" >
                            <Row className="m-2 mb-5 p-1">
            ...
            <ProfileCEO />
                <section className="section pb-0 section-components ">
                    <Container className="mb-5">
                        <Card className="card-profile shadow" data-aos="fade-down" >
                            <Row className="m-2 mb-5 ">
