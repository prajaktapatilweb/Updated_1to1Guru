...
export default function Jeemainhero() {
  return (
    <div>
              ...
              <Col className=" text-center " lg="6">
                ...
                >
                  ...
                  <p className="display-3 mb-0 py-5 text-udfc-orange ">
                    Succeed in IIT JEE Mains & JEE Advance 2022
                    <span className="display-4">
                      {" "}
                      <i> via strong foundation in Physics, Chemistry & Maths </i>
                    </span>
                  </p>
                  ...
                  <Row>
                    <Col>
                      <p className="display-4" style={{ color: " #fb6340" }}>
                        Enrol to our IIT-JEE Mains & Advance 2022 courses for</p>
